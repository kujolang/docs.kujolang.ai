---
title: Choose a path
description: Start with an intent and one small next step instead of browsing the whole ecosystem.
custom_url: choose-a-path
template: docs
section: Start here
nav_title: Choose a path
order: 40
audience: all
difficulty: beginner
status: stable
...
| Run an editorial pipeline | [StoryDesk](/tools/storydesk/), [Dossier](/tools/dossier/), [BluePencil](/tools/bluepencil/), [GalleyPack](/tools/galleypack/), and [PressWire](/tools/presswire/) |
| Review a consequential decision | [Tribunal](/tools/tribunal/) |
